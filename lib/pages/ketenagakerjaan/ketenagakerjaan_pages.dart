...
class KetenagakerjaanPages extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView( // Ganti Column ke ListView agar bisa di-scroll jika banyak
        padding: const EdgeInsets.only(top: 24.0), // Padding di atas
        children: [
          //News
          ...ketenagakerjaan.map((item) => Container(
                // --- PERUBAHAN TAMPILAN ---
