...
class _BeritaPageState extends State<BeritaPages> {
  ...
  Future<void> fetchDataBRS() async {
    ...
    final String apiUrl = "http://webapi.bps.go.id/v1/api/list/model/pressrelease/lang/ind/domain/3573/page/$currentPage/key/9db89e91c3c142df678e65a78c4e547f";
        ...
        final parsedResponse = json.decode(response.body);
         if (parsedResponse != null && parsedResponse['data'] != null && parsedResponse['data'].length > 1 && parsedResponse['data'][1] is List) {
            ...
            for (var item in brs) {
              ...
              final String favoriteKey = 'favorite_brs_$postId'; 
            ...
            if (mounted) { 
             ...
             print("Struktur data API BRS tidak valid atau kosong.");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading && dataBRS.isEmpty
                          ...
                          onTap: () {
                            showDownloadDialog(
                              ...
                              (String updatedPostId, bool newStatus) {
                                final itemIndex = dataBRS.indexWhere((i) => (i['title'] ?? '') == updatedPostId);
  ...
  // ... (Sisa kode downloadAndShowConfirmation, _checkPermission, openPdfDirectly, PDFViewer tetap sama) ...
      ...
      try {
        ...
        FileDownloader.downloadFile(
          ...
          onDownloadCompleted: (String path) {
            ...
            Fluttertoast.showToast(
              msg: 'BRS "$safeFileName.pdf" telah disimpan dalam Folder Download.',
              toastLength: Toast.LENGTH_LONG,
              gravity: ToastGravity.CENTER,
              backgroundColor: Colors.blue,
              textColor: Colors.white,
